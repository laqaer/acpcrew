// Vendor stub: re-exports @junction/app-sdk from the host.
const m = window.__junction_modules?.['@junction/app-sdk']
if (!m) throw new Error('[vendor/junction-app-sdk] Host modules not initialized.')
export const {
