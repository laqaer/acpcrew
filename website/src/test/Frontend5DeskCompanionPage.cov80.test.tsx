...
import { REMINDERS_PATH, STATS_PATH } from '../apps/desk-companion/constants'
import type { RemindersPayload, StatsPayload } from '../apps/desk-companion/types'

const apiGet = vi.fn()
const apiPost = vi.fn()
vi.mock('../apps/desk-companion/api', () => ({
