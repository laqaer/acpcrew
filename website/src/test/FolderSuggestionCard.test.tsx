...
describe('FolderSuggestionCard', () => {
  ...
  it('shows the breadcrumb as ancestry context when the folder is nested', () => {
    renderCard()
    expect(screen.getByText('Junction › feature')).toBeInTheDocument()
  })
  ...
  it('always renders the lucide glyph, never a folder emoji', () => {
    ...
    const { container } = render(
      <FolderSuggestionCard folderName="i18n" breadcrumb="Junction › i18n" onAccept={vi.fn()} onDecline={vi.fn()} />,
    )
