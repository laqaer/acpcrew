...
vi.mock('../apps/desk-companion/petdexImport', () => ({
...
vi.mock('../apps/desk-companion/PackEditor', () => ({
...
vi.mock('../apps/desk-companion/SpriteImporter', () => ({
...
const { GalleryPanel } = await import('../apps/desk-companion/GalleryPanel')
