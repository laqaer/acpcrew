...
import { PENDING_PATH, PRESENCE_PATH } from '../apps/desk-companion/constants'
import type { SessionWatchOptions } from '../apps/desk-companion/sessionWatch'
...
vi.mock('../apps/desk-companion/sessionWatch', () => ({
...
async function mountPet(): Promise<void> {
  ...
  vi.resetModules()
  await import('../apps/desk-companion/pet')
