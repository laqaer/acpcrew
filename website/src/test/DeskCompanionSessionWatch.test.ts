...
import { watchSessions, type SessionDone } from '../apps/desk-companion/sessionWatch'
import { TURN_NOTIFY_MIN_MS, BG_AGENT_PREFIX } from '../apps/desk-companion/completionGate'
