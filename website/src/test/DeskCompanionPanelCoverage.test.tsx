...
import type { PanelCardProps } from '../apps/desk-companion/PanelCard'
...
vi.mock('../apps/desk-companion/petBridge', () => ({ petBridge: petBridgeStub }))
 ...
 */
vi.mock('../apps/desk-companion/PanelCard', () => ({
...
vi.mock('../apps/desk-companion/BreathingOverlay', () => ({
...
async function mountPanel(): Promise<void> {
  ...
  vi.resetModules()
  await import('../apps/desk-companion/panel')
  await waitFor(() =>
