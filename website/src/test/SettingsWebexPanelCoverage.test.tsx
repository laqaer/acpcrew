...
const SETUP_GUIDE =
  'https://github.com/laqaer/junction/blob/main/src/kiro_crew/docs/webex-integration.md'
...
describe('WebexPanel read-only session', () => {
  it('drops every writer and shows the stored preview only', async () => {
    ...
    expect(
      screen.getByText(
        'Webex settings are managed on the machine running Junction and are read-only from remote sessions.',
      ),
    ).toBeInTheDocument()
