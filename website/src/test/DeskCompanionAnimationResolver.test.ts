...
import { AnimationResolver, toDataUri } from '../apps/desk-companion/animationResolver'
import { applySvgColorMap } from '../apps/desk-companion/colorCustomizer'
import type { PackManifest } from '../apps/desk-companion/appearanceTypes'
import type { PetState, PetMood } from '../apps/desk-companion/types'
