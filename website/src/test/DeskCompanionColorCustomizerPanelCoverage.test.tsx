/**
 * `apps/desk-companion/ColorCustomizerPanel.tsx` — the companion's whole
...
import type { CatPreset } from '../apps/desk-companion/catPresets'
import type { ColorMap } from '../apps/desk-companion/colorCustomizer'
...
vi.mock('../apps/desk-companion/petBridge', () => ({ petBridge: bridge, galleryApi: bridge }))

const { ColorCustomizerPanel } = await import('../apps/desk-companion/ColorCustomizerPanel')
const { BUILT_IN_CAT_PRESETS } = await import('../apps/desk-companion/builtInCatPresets')
const { applySvgColorMap } = await import('../apps/desk-companion/colorCustomizer')
const { toDataUri } = await import('../apps/desk-companion/animationResolver')
