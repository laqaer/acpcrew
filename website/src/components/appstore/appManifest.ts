...
export const APP_MANIFEST_KEY: Record<string, ManifestKeys> = {
  ...
  'desk-companion': {
    displayName: 'apps.deskCompanion.manifest.display_name',
    description: 'apps.deskCompanion.manifest.description',
    pageLabel: 'apps.deskCompanion.manifest.page_label',
    highlights: [
      'apps.deskCompanion.manifest.highlight_1',
      'apps.deskCompanion.manifest.highlight_2',
      'apps.deskCompanion.manifest.highlight_3',
      'apps.deskCompanion.manifest.highlight_4',
      'apps.deskCompanion.manifest.highlight_5',
    ],
    useCases: ['apps.deskCompanion.manifest.use_case_1'],
    configuration: ['apps.deskCompanion.manifest.configuration_1'],
  },
  'design-critique': {
