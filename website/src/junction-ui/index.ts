/**
 * @junction/ui — shared component library for Junction apps.
 *
 ...
 * standalone package, the import map resolves `@junction/ui` to the
 * host's vendored copy — ensuring a single set of components and styles.
 *
 * Usage in apps:
 *   import { Card, Btn, Badge, PageHeader } from '@junction/ui'
 */
