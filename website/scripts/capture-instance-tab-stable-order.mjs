 ...
 * the same approach as `capture-instance-pin-chips.mjs`, so the switcher measured
 ...
 *
 * Usage: npm run build && node scripts/capture-instance-tab-stable-order.mjs [outDir]
 */
