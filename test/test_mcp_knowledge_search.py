...
class TestKnowledgeSearchDBMissing:
    @patch("junction.mcp_core.config_dir")
...
class TestKnowledgeSearchResults:
    @patch("junction.mcp_core.config_dir")
    @patch("junction.mcp_core.HybridRetriever")
    @patch("junction.mcp_core.KnowledgeStore")
    @patch("junction.mcp_core.create_embedder_from_config")
...
class TestKnowledgeSearchToolDefinition:
    def test_tool_listed(self):
        from junction.mcp_core import _list_tools
...
class TestKnowledgeSearchSourceFilter:
    ...
    @patch("junction.mcp_core.config_dir")
    @patch("junction.mcp_core.HybridRetriever")
    @patch("junction.mcp_core._get_knowledge_search")
