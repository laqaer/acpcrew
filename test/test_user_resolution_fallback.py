...
from junction.config.loader import JunctionConfig, MessagingConfig, SlackConfig
...
def _make_orch(allowed_users: list[dict] | None = None) -> MagicMock:
    ...
    orch._cfg = JunctionConfig(slack=slack_cfg, messaging=MessagingConfig(use_transport=False))
