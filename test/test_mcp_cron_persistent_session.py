...
from junction.mcp_cron import _call_tool_inner, _list_tools, _validate_args
...
def _isolate_cron_store(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("JUNCTION_SESSION_KEY", "dashboard:psess-slot")
...
class TestCronAddPersistentSessionValidation:
    ...
    def test_schema_has_persistent_session_bool_field(self):
        ...
        from junction.validation import CRON_ADD_SCHEMA
