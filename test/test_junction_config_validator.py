"""Tests for the api_junction_config PUT validator's max_subagents handling.
...
from junction.dashboard.handlers.core import api_junction_config
...
async def _put(agent_settings: dict, cfg_path) -> web.Response:
    ...
    with patch("junction.config.loader.config_path", return_value=cfg_path):
        return await api_junction_config(request)
