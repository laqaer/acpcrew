...
one wait budget: ``junction.constants.COMPACT_WAIT_TIMEOUT_SECS``. A shorter
...
@pytest.mark.parametrize(
    "import_path",
    [
        "junction.providers.acp.AcpProvider",
        "junction.acp.client.AcpClient",
        "junction.acp.session_handle.AcpSessionHandle",
...
def test_inner_status_wait_spends_the_remaining_shared_budget():
    ...
    from junction.session import _compact_result_wait_secs
