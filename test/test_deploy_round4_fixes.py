...
class TestTeardownProfileValidation:
    ...
    async def test_bad_region_rejected(self):
        ...
        from junction.deploy.profiles import REGION_SPEC
        from junction.validation import ValidationError, validate_field
...
class TestIAMOACPolicy:
    ...
    def test_oac_statement_no_tag_condition(self):
        ...
        from junction.deploy.iam import policy_json
...
class TestDeployWebCompatRedirect:
    ...
    def _make_app() -> web.Application:
        ...
        from junction.deploy.handlers import register_routes
        register_routes(app)
