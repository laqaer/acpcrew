"""Structured error types for junction-client."""
...
def http_error(status: int, body: Any = None) -> JunctionError:
    ...
    return JunctionError(code, message, status=status, body=body)
