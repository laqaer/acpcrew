"""Tests for the select_crew MCP tool (junction.mcp_core._do_select_crew)."""
...
def _write_cfg(tmp_path: Path) -> Path:
    data = {
        "agents": {
            "default": {"kiro_agent": "junction", "workspace": "default", "memory_store": "default"},
            "oncall": {
...
def test_schema_accepts_crew_names_with_spaces_and_dots():
    ...
    from junction.validation import SELECT_CREW_SCHEMA, validate_tool_args
