...
| [model-router.md](model-router.md) | Optional Codex Router sidecar: health, namespaced catalog, role DAG (orchestration → planning → execution), no secrets, degraded if absent. |
