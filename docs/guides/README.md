...
Task-oriented documentation: how to install, run, and operate Junction. For how the
system is built, see [../architecture/](../architecture/README.md).

| Guide | Covers |
|---|---|
| [install.md](install.md) | Installing and building Junction: source, wheel, and first run. |
...
| [docker.md](docker.md) | Running Junction as a container. |
...
| [remote-instance-on-ec2.md](remote-instance-on-ec2.md) | Reaching a remote Junction gateway on EC2 over SSH or AWS SSM, plus the common EC2 setup gotchas (sandbox backend, linger, port/tunnel matching). |
