...
Where this checkout's two lineages come from, and what Junction does
**not** take from them. Product identity is Junction; these files name
upstream projects, not the product.
