...
| Site | Marketing overlay: Junction, two planes, amber, track motif, no ghost emoji; honest M1 vs M2 copy | `site/` | Preview at [junction-site.vercel.app](https://junction-site.vercel.app) | [#18](https://github.com/laqaer/junction/issues/18) |
| CLI chrome | Primary `junction`; aliases `acpcrew` / `kirocrew` | CLI packaging / entry | Done via #23 | [#19](https://github.com/laqaer/junction/issues/19) |
| Model-router | Observe + compose: health/status, catalog, role DAG; advertised ids actually applied; sidecar slugs skipped until M2 | `src/kiro_crew/model_router/`, [model-router spec](system-specs/modules/model-router.md) | Catalog via #24; apply via this PR | [#20](https://github.com/laqaer/junction/issues/20) |
...
| M2 router install | Operator-install of published Codex Router; optional `openai_base_url`; secrets stay in the sidecar | Docs + later compose | Follow-up | [#22](https://github.com/laqaer/junction/issues/22) |
