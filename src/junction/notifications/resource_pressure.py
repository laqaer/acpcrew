...
computed by :mod:`junction.resource_status` reaches agents (the injected
...
from junction.notifications.bus import NotificationPayload
...
from junction.sandbox import check_agents_slice_pressure
...
class ResourcePressureNotifier:
    ...
    def _run_probe(self) -> ResourceStatus:
        ...
        try:
            ...
            # cadence: new OOM kills inside junction-agents.slice are logged
