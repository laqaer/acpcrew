...
# tests patch (`patch("junction.apps.teardown.on_app_disable")`), and a
...
from junction.apps.bridges import deregister_app
from junction.apps.hooks_integration import (
    on_app_disable,
    stop_app_startup_hooks,
)
from junction.apps.lifecycle_scripts import run_lifecycle_script
...
async def teardown_app_runtime(
    ...
    * ``True`` — **trust withdrawal** (a security operation: revoke, or the blanket
    ...
    #   (b) "revocation can leave DETACHED app code running" — `junction app
