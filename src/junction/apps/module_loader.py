...
from junction.apps.execution import app_execution_denied, is_builtin_app
from junction.sel import sel

logger = logging.getLogger(__name__)

# Builtin apps ship inside the Junction package and are trusted like core code.
...
def _app_namespace_root(app_name: str) -> str:
    ...
    prefix of another's -- ``_junction_app_foo`` and ``_junction_app_foo-bar``
    ...
    """
    return f"_junction_app_{app_name}"
