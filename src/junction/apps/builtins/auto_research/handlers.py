...
from junction.apps.builtins.auto_research import subquestion_queue as _sq
...
from junction.history import on_loop_persist_strict
from junction.knowledge.llm_pool import LLMPool
from junction.llm_helpers import _extract_json_of_type
from junction.platform_compat import is_link_or_junction, unlink_link_or_junction
...
# the junction-research agent's system prompt, so this only needs to name the cycle.
_RESEARCH_AGENT = "junction-research"
_RESEARCH_NUDGE = (
