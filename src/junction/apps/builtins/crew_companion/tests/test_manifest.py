...
from junction.apps.builtins.crew_companion import hooks as hooks_mod
from junction.apps.builtins.crew_companion.backend import routes as routes_mod
...
# repo_root/src/junction/apps/builtins/crew_companion/tests/test_manifest.py
