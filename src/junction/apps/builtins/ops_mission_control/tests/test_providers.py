...
from junction.apps.builtins.ops_mission_control.backend.models import (
    ACTION_COMMENT,
    ACTION_RESOLVE,
    ACTION_SILENCE,
...
from junction.apps.builtins.ops_mission_control.backend.providers.base import (
    ActionResult,
    Evidence,
    EvidenceBudget,
    ShiftStatus,
)
from junction.apps.builtins.ops_mission_control.backend.registry import (
    OpsProviderRegistry,
)
...
class TestPollHealthAndBackoff(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_the_real_webhook_source_declares_itself_non_snapshot(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.providers import webhook

        self.assertFalse(webhook.WebhookSignalSource.is_snapshot)

    async def test_a_429_honours_the_providers_retry_after(self):
        from junction.apps.builtins.ops_mission_control.backend.providers.http import HttpError
...
class TestRetryAfterParsing(unittest.TestCase):
    def test_delta_seconds_is_honoured_and_clamped(self):
        from junction.apps.builtins.ops_mission_control.backend.providers import http
...
class TestRotationResolution(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_the_always_on_default_does_not_mask_a_real_rotation(self):
        ...
        """
        from junction.apps.builtins.ops_mission_control.backend.providers import noop
...
class TestEvidenceRedaction(unittest.IsolatedAsyncioTestCase):
    ...
    Isolates ``JUNCTION_HOME`` because the config-resolution tests WRITE provider
    ...
    def setUp(self):
        ...
        self._prev_home = os.environ.get("JUNCTION_HOME")
        os.environ["JUNCTION_HOME"] = str(self._tmp)
    ...
    def tearDown(self):
        ...
        if self._prev_home is None:
            ...
            os.environ["JUNCTION_HOME"] = self._prev_home
    ...
    async def test_config_flag_accepts_what_an_operator_would_type(self):
        ...
        """
        from junction.apps.builtins.ops_mission_control.backend.providers import (
            config_flag,
    ...
    async def test_cloudwatch_detail_mentions_the_stale_metric_opt_in(self):
        ...
        """
        from junction.apps.builtins.ops_mission_control.backend.providers import cloudwatch
    ...
    async def test_each_source_is_waited_on_its_own_resolved_budget(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import registry as reg_mod
...
class TestPublicAdapterDefaults(unittest.IsolatedAsyncioTestCase):
    ...
    ``JUNCTION_HOME`` is redirected to an empty temp dir. Without it these tests
    ...
    def setUp(self):
        ...
        self._prev_home = os.environ.get("JUNCTION_HOME")
        os.environ["JUNCTION_HOME"] = str(self.tmp)
    ...
    async def test_public_registry_installs_expected_adapters(self):
        from junction.apps.builtins.ops_mission_control.backend import registry as reg
...
class TestSuppressionIsAlwaysBounded(unittest.IsolatedAsyncioTestCase):
    ...
    def test_a_requested_window_is_clamped_not_honoured_blindly(self):
        from junction.apps.builtins.ops_mission_control.backend import models
    ...
    async def test_datadog_mute_always_carries_an_end(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.providers import datadog
    ...
    async def test_github_does_not_claim_a_suppression_it_cannot_perform(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.providers import github_issues
...
class TestHttpHelper(unittest.IsolatedAsyncioTestCase):
    async def test_non_https_is_refused(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.providers.http import (
            HttpError,
            request_json,
        )
...
class TestACloudWatchFaultIsNotAQuietEstate(unittest.IsolatedAsyncioTestCase):
    ...
    **expired credentials**) and a ``describe_alarms`` exception — and returned ``[]`` or the
    ...
    async def test_the_registry_records_the_fault_as_unhealthy(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import registry
        from junction.apps.builtins.ops_mission_control.backend.providers import cloudwatch
...
class TestPagerDutyCannotBorrowATeammatesShift(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self) -> None:
        ...
        self._prev = os.environ.get("JUNCTION_HOME")
    ...
    def tearDown(self) -> None:
        if self._prev is None:
            ...
            os.environ["JUNCTION_HOME"] = self._prev
        shutil.rmtree(self.tmp, ignore_errors=True)

    def _adapter(self):
        from junction.apps.builtins.ops_mission_control.backend.providers import pagerduty
...
class TestConcurrentStoreWritesDoNotLoseData(unittest.TestCase):
    ...
    def test_concurrent_secret_saves_keep_both_credentials(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.secrets import KeystoneFileBackend
    ...
    def test_no_module_open_codes_a_config_read_modify_write(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.providers import __file__ as pf
    ...
    def test_both_stores_lock_their_read_modify_write(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import secrets
        from junction.apps.builtins.ops_mission_control.backend.providers import (
            merge_provider_config,
            set_top_level,
        )
...
class TestCloudWatchAlarmsArePaged(unittest.IsolatedAsyncioTestCase):
    ...
    def _enable(self) -> None:
        from junction.apps.builtins.ops_mission_control.backend.providers import set_top_level
