...
from junction.apps.builtins.ops_mission_control.backend import slack_out, store
...
class TestSlackLinkTargetIsValidated(unittest.TestCase):
    ...
    def test_the_block_omits_the_link_rather_than_rendering_it_broken(self):
        from junction.apps.builtins.ops_mission_control.backend import models, slack_out
