...
``JUNCTION_HOME`` is redirected to a temp dir so nothing here touches the real
data home.
"""
...
class TestClaim(_HomeIsolated):
    def test_claim_creates_incident(self):
        from junction.apps.builtins.ops_mission_control.backend import models, store
...
class TestClosingAnIncidentLeavesAnArtifact(_HomeIsolated):
    """A closed incident must leave a Markdown record a non-Junction reader can be handed.
...
class TestAutonomyGate(_HomeIsolated):
    ...
    def test_default_is_observe(self):
        from junction.apps.builtins.ops_mission_control.backend import models, rotation
    ...
    def test_unknown_action_refused(self):
        from junction.apps.builtins.ops_mission_control.backend import rotation
...
class TestTierArming(_HomeIsolated):
    ...
    def test_the_spec_table_matches_the_shipped_tiers_and_enabled_flags(self):
        ...
        # repo_root/src/junction/apps/builtins/<app> -> repo_root
...
class TestLedger(_HomeIsolated):
    def test_upsert_then_match(self):
        from junction.apps.builtins.ops_mission_control.backend import ledger, models
...
class TestTheSweepWindowsAreReadableBack(_HomeIsolated):
    ...
    def test_the_defaults_in_force_are_reported_without_any_config(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch, rotation, store
    ...
    def test_an_unset_needs_human_window_is_reported_resolved_not_as_zero(self):
        ...
        """
        from junction.apps.builtins.ops_mission_control.backend import rotation, store
    ...
    def test_the_reported_windows_are_the_ones_the_heartbeat_actually_applies(self):
        ...
        """
        from junction.apps.builtins.ops_mission_control.backend import dispatch, rotation
