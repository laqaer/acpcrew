...
class _HomeIsolated(unittest.IsolatedAsyncioTestCase):
    ...
    def _signal(native_id="alarm/dlq", title="DLQ depth exceeded", **kw):
        from junction.apps.builtins.ops_mission_control.backend.models import Signal
    ...
    def _write_config(self, payload):
        from junction.apps.builtins.ops_mission_control.backend import store as store_mod
...
class TestCycleSilence(_HomeIsolated):
    async def test_no_signals_means_no_change(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch
    ...
    async def test_a_resolved_alarm_refiring_is_claimed_through_run_cycle(self):
        ...
        """
        from junction.apps.builtins.ops_mission_control.backend import dispatch, models, store
    ...
    async def test_non_firing_signal_is_ignored(self):
        from junction.apps.builtins.ops_mission_control.backend import dispatch
        from junction.apps.builtins.ops_mission_control.backend.models import STATE_OK
...
class TestSuppressedSignalsAreNeverClaimed(_HomeIsolated):
    ...
    async def test_a_parked_signal_is_not_claimed(self):
        from junction.apps.builtins.ops_mission_control.backend import dispatch
        from junction.apps.builtins.ops_mission_control.backend.models import STATE_SUPPRESSED
...
class TestLedgerWiring(_HomeIsolated):
    ...
    async def test_matching_pattern_is_attached_and_persisted(self):
        from junction.apps.builtins.ops_mission_control.backend import dispatch, store
    ...
    async def test_weak_match_is_not_the_fast_path(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch, ledger
        from junction.apps.builtins.ops_mission_control.backend.models import (
            CONFIDENCE_LOW,
            TRUST_OBSERVED,
            LedgerEntry,
...
class TestPostActionVerification(_HomeIsolated):
    ...
    def _acted_incident(self, signal, *, action="silence", due="2020-01-01T00:00:00Z"):
        ...
        from junction.apps.builtins.ops_mission_control.backend import store
        from junction.apps.builtins.ops_mission_control.backend.models import (
            MODE_ACT,
            VERIFY_PENDING,
        )
    ...
    async def test_a_signal_gone_from_a_healthy_poll_confirms_the_action(self):
        from junction.apps.builtins.ops_mission_control.backend import dispatch, store
        from junction.apps.builtins.ops_mission_control.backend.models import VERIFY_CLEARED
    ...
    async def test_a_recheck_that_is_not_due_yet_reaches_no_verdict(self):
        from junction.apps.builtins.ops_mission_control.backend import dispatch, store
        from junction.apps.builtins.ops_mission_control.backend.models import VERIFY_PENDING
    ...
    async def test_a_still_firing_verdict_charges_a_miss_to_every_matched_entry(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch, ledger, store
    ...
    async def test_a_cleared_verification_is_not_news_but_a_still_firing_one_is(self):
        ...
        can find.
        """
        from junction.apps.builtins.ops_mission_control.backend.dispatch import CycleResult
        from junction.apps.builtins.ops_mission_control.backend.models import (
            VERIFY_CLEARED,
            VERIFY_STILL_FIRING,
            VERIFY_UNKNOWN,
    ...
    async def test_an_incident_with_no_action_is_never_verified(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch, store
        from junction.apps.builtins.ops_mission_control.backend.models import MODE_OBSERVE
...
class TestEveryInstancePullsTheSchedule(_HomeIsolated):
    ...
    async def test_the_cycle_pulls_before_it_reads_the_shift(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch, registry
    ...
    async def test_an_unreachable_remote_does_not_stop_the_cycle(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import (
            dispatch,
            ledger_sync,
        )
    ...
    async def test_the_pull_helper_swallows_every_fault(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import dispatch, ledger_sync
