...
from junction.apps.builtins.ops_mission_control.backend import ledger, ledger_index
...
class TestSemanticRecallWiring(_Env):
    ...
    def _claimed(title: str = "DLQ fills on AccessDenied", resource: str = "my-queue"):
        from junction.apps.builtins.ops_mission_control.backend import store as inc_store
        from junction.apps.builtins.ops_mission_control.backend.dispatch import (
            ClaimedIncident,
        )
