...
class TestTheCeilingIsOnTheKeystoneFloor(_HomeIsolated):
    def test_the_policy_file_is_fenced_and_config_is_not(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.store import APP_NAME
    ...
    def test_rotation_reads_mode_and_rules_from_the_store(self):
        from junction.apps.builtins.ops_mission_control.backend import policy_store, rotation
...
class TestOutboundDestinationsAreOperatorOnly(_HomeIsolated):
    ...
    def test_an_agent_write_cannot_move_the_ledger_remote(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend.providers import write_config
    ...
    def test_an_agent_write_cannot_move_the_slack_channel(self):
        from junction.apps.builtins.ops_mission_control.backend import slack_out
        from junction.apps.builtins.ops_mission_control.backend.providers import write_config
    ...
    def test_the_branch_stays_in_plain_config_deliberately(self):
        ...
        from junction.apps.builtins.ops_mission_control.backend import ledger_sync, policy_store
        from junction.apps.builtins.ops_mission_control.backend.providers import read_config
...
class TestPolicyLockdownOrdering(_HomeIsolated):
    ...
    def test_write_lockdown_precedes_content(self):
        ...
        with mock.patch("junction.platform_compat.restrict_to_owner", _measuring):
    ...
    def test_a_failed_lockdown_preserves_the_previous_ceiling(self):
        ...
        with mock.patch("junction.platform_compat.restrict_to_owner", _refuse):
    ...
    def test_a_failed_payload_write_preserves_the_previous_ceiling(self):
        ...
        with mock.patch(
            "junction.atomic_write.tempfile", types.SimpleNamespace(mkstemp=_no_space)
        ):
            with self.assertRaises(OSError):
                policy_store.set_mode(models.MODE_ACT)
