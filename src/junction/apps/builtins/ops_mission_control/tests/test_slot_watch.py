...
class TestDeriveStatus(_HomeIsolated):
    def test_pending_approval_flag_blocks(self):
        from junction.apps.builtins.ops_mission_control.backend import slot_watch
        from junction.apps.builtins.ops_mission_control.backend.models import (
            BLOCKED_ON_APPROVAL,
            STATUS_NEEDS_HUMAN,
        )
    ...
    def test_idle_slot_with_a_diagnosis_is_left_alone(self):
        from junction.apps.builtins.ops_mission_control.backend import slot_watch, store
