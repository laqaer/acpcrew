...
from junction.apps.builtins.ops_mission_control.backend import companion, registry
...
class _AdmissionPatch:
    ...
    `junction.platform.admission` would not affect the already-bound references. Patch where
...
class TestGroupSeparation(unittest.TestCase):
    def test_ops_group_is_not_the_platform_plugin_group(self) -> None:
        ...
        from junction.platform.discovery import PLUGIN_GROUP
