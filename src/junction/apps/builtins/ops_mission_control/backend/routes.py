...
from junction.apps.builtins.ops_mission_control.backend.providers import webhook as webhook_mod
from junction.apps.builtins.ops_mission_control.backend.registry import get_registry
from junction.apps.builtins.ops_mission_control.backend.secrets import (
    delete_secret,
    describe_secrets,
    put_secret,
    redact_tokens,
...
from junction.platform.context import redact_via_context
...
def _index_ledger_safely() -> dict[str, int]:
    ...
    """
    from junction.apps.builtins.ops_mission_control.backend import ledger_index
    ...
    try:
        ...
        store_obj = VectorMemoryStore(embedding_dim=JunctionConfig.load().memory.embedding_dim)
        store_obj.init()
