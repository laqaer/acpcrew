...
from junction.apps.builtins.ops_mission_control.backend.providers import read_config, webhook
...
def _safe_field(text: str) -> str:
    ...
    if not text:
        return text
    from junction.apps.builtins.ops_mission_control.backend.secrets import redact_tokens
