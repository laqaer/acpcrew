...
from junction.apps.builtins.ops_mission_control.backend.models import Signal, utc_now_iso
...
class OpsProviderRegistry:
    ...
    async def gather_evidence(self, signal: Signal, budget: EvidenceBudget) -> list[Evidence]:
        ...
        from junction.platform.context import redact_via_context as core_redact
...
def _install_companions(registry: OpsProviderRegistry) -> None:
    ...
    """
    try:
        from junction.apps.builtins.ops_mission_control.backend.companion import (
