...
_SERVER_DIFF = """--- a/src/junction/gateway/server.py
+++ b/src/junction/gateway/server.py
@@ -10,7 +10,9 @@
 import asyncio
+import logging
 def restart(self):
...
_FORMAT_DIFF = """--- a/src/junction/util/format.py
+++ b/src/junction/util/format.py
@@ -1,2 +1,3 @@
-def f(x): pass
+def f(x):
+    return str(x)
...
SENSITIVE_FILES = [
    {"path": "src/junction/gateway/server.py", "diff": _SERVER_DIFF},
    {"path": "src/junction/util/format.py", "diff": _FORMAT_DIFF},
]
