...
from junction.apps.builtins.code_review_sage.tests.fixtures import SYMLINKS_OK
...
class _Base(unittest.TestCase):
    def setUp(self):
        ...
        self._old = os.environ.get("JUNCTION_HOME")
    ...
    def tearDown(self):
        if self._old is None:
            ...
            os.environ["JUNCTION_HOME"] = self._old
