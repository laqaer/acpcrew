...
other gh surface via ``junction.github_runner`` (trusted-binary resolution +
...
# the standalone path, where `junction` is not importable. A bare module-level
...
_GH_OVERRIDE_ENV = "JUNCTION_SAGE_GH"
