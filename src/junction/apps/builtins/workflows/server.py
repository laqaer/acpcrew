...
dashboard "Workflows" tab. Junction proxies ``/apps/workflows/api/*`` to this
...
logger = logging.getLogger("junction.app.workflows")
...
APP_NAME = os.environ.get("JUNCTION_APP_NAME", "workflows")
