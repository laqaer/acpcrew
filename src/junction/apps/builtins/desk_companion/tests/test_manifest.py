...
fields point at brand SVGs under ``/app-assets/desk-companion/`` served by the
...
from junction.apps.builtins.desk_companion import hooks as hooks_mod
from junction.apps.builtins.desk_companion.backend import routes as routes_mod
...
# repo_root/src/junction/apps/builtins/desk_companion/tests/test_manifest.py
...
_ASSET_PREFIX = "/app-assets/desk-companion/"
...
def test_asset_urls_under_app_assets_and_files_exist() -> None:
    ...
    # website/public/app-assets/desk-companion/. They are present as of writing
