...
from junction.apps.builtins import BUILTIN_NAMES, personal_shopper
from junction.apps.builtins.personal_shopper.backend import store as store_mod
from junction.apps.builtins.personal_shopper.backend.store import PreferenceStore
...
class TestManifestWiring(unittest.TestCase):
    ...
    def test_declared_assets_exist(self) -> None:
        ...
        manifest = json.loads(manifest_path.read_text(encoding="utf-8"))
        # tests/ -> personal_shopper -> builtins -> apps -> junction -> src -> repo
