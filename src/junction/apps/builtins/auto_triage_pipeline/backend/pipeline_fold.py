...
from junction.apps.builtins.issue_radar.backend import store as issue_radar_store
from junction.apps.manager import app_dir
from junction.config.paths import data_home
from junction.memory import workspace_dir
...
#: Matches a pull-request URL tail, e.g. ".../Junction/pull/5600".
