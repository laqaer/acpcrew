...
from junction.apps.builtins.mochi.soul_loader import rendered_bg_prompt_path, rendered_prompt_path
from junction.atomic_write import atomic_write

logger = logging.getLogger(__name__)

#: Filename the framework reads from the app's data dir. Must match
#: ``junction.apps.bridges.AGENT_MCP_POLICY_FILE``.
...
def apply_policy(data_dir: Path, settings: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        from junction.apps.bridges import get_app_manifest, refresh_app_agents
