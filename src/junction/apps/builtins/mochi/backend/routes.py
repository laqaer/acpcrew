...
through :func:`junction.apps.builtins.mochi.hooks` — the runtime the
...
from junction.apps.builtins.mochi import activity_log, hooks
from junction.apps.builtins.mochi import queue_file as qf
from junction.apps.builtins.mochi import watchlist_file as wf
from junction.apps.builtins.mochi.activity_log import (
    LOG_FILE,
    YESTERDAY_LOG_FILE,
    activity_mutation,
)
from junction.apps.builtins.mochi.agent_policy import PolicyNotMaterialized, apply_policy
...
from junction.apps.builtins.mochi.petdex_import import (
    PetdexError,
    fetch_pet,
    list_installed,
    read_installed,
)
from junction.apps.builtins.mochi.pinned_files_service import DATA_FILE_NAME, pins_mutation
from junction.apps.builtins.mochi.queue_file import QUEUE_FILE as _QUEUE_FILE
from junction.apps.builtins.mochi.queue_file import queue_mutation
from junction.apps.builtins.mochi.redact import redact_tree
...
from junction.apps.builtins.mochi.watchlist_file import watchlist_mutation
from junction.apps.builtins.mochi.watchlist_service import _ARCHIVE_FILE, _WATCHLIST_FILE
...
from junction.mcp_discovery import list_servers, probe_server
