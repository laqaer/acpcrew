...
which on a stalled network filesystem (a ``JUNCTION_HOME`` on NFS/SMB) block for
...
from junction.apps.builtins.papyrus.backend import gitops, latex, store, tectonic
