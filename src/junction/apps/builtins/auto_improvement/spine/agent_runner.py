...
from junction.hooks import TOOL_DENY, HookManager, hooks_config_from_config_dict
from junction.platform_compat import SIGKILL, kill_process_tree
...
class SessionAgentRunner:
    ...
    def __init__(
        ...
        *,
        ...
        # gets only file/shell tools and NOT the gateway's junction-core MCP tools.
    ...
    def ensure_agent_registered(self) -> bool:
        ...
        DEFAULT agent, which carries the full junction-core toolset (including
    ...
    async def _run_async(
        ...
        *,
        ...
        # and the session inherited the default agent's full junction-core toolset.)
