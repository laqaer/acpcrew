...
from junction.apps.builtins.auto_improvement.profiles.github_repo import pr_recipe as pr
from junction.apps.builtins.auto_improvement.spine.profile import PRRecipe
...
class TestScanNotesCarryNoScannedContent:
    ...
    def test_scanner_import_failure_note_is_a_literal(self, monkeypatch) -> None:
        ...
        def _no_security(name, *a, **kw):
            if name == "junction.security":
                raise ImportError("/home/someone/secret/path/junction/security.py missing")
    ...
    def test_logged_code_locus_cannot_carry_a_credential(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.keeper import _locus
    ...
    def test_guardrail_verdict_code_is_slug_shaped(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.keeper import _metric_slug
...
class TestScannerReturnsCodesNotMessages:
    ...
    def test_reason_table_is_all_literals(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.push_policy import SCAN_REASON_TEXT
    ...
    def test_describe_scan_is_total(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.push_policy import describe_scan
...
class TestLoggedStringsAreRebuiltFromConstants:
    ...
    def test_locus_output_uses_only_its_alphabet(self) -> None:
        from junction.apps.builtins.auto_improvement.spine.keeper import (
            _LOCUS_ALPHABET,
            _locus,
        )
    ...
    def test_empty_input_yields_a_placeholder_not_an_empty_field(self) -> None:
        from junction.apps.builtins.auto_improvement.spine.keeper import _locus, _metric_slug
...
class TestOriginUrlMigratesOldConfigs:
    ...
    def test_a_config_without_origin_url_still_resolves_a_target(self) -> None:
        from junction.apps.builtins.auto_improvement.backend.clone_setup import (
            resolve_origin_url,
        )
