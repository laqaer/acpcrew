...
from junction.apps.builtins.auto_improvement.backend import deps, mcp_server, progress, store
...
class TestMcpServer:
    ...
    def test_an_unauditable_call_is_refused_not_served(
        ...
        # so patching `junction.sel` would leave the already-bound reference in place and
...
class TestMcpResultsAreRedacted:
    ...
    def test_a_credential_in_a_ledger_note_does_not_reach_the_result(
        ...
        from junction.apps.builtins.auto_improvement.backend import mcp_server, store
    ...
    def test_redaction_runs_before_truncation(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend import mcp_server
