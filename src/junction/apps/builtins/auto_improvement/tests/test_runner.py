...
class FakeAgentRunner:
    ...
    def run(self, prompt: str, *, cwd: str | None = None, **_kw: Any) -> Any:
        from junction.apps.builtins.auto_improvement.spine.agent_runner import AgentResult
...
class TestCalibrationWritesToTheLaunchedWorkspace:
    ...
    def test_a_retarget_mid_calibration_does_not_move_the_ruler(
        ...
        from junction.apps.builtins.auto_improvement.backend import runner as RR
        from junction.apps.builtins.auto_improvement.backend import store
        ...
        monkeypatch.setattr(
            "junction.apps.builtins.auto_improvement.profiles.build_profile",
            lambda cfg: _Profile(),
        )
