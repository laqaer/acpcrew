...
class TestStubProfileImport:
    ...
    def test_stub_profile_module_is_importable(self) -> None:
        from junction.apps.builtins.auto_improvement.spine.stub_profile import StubProfile
    ...
    def test_it_is_the_same_class_as_in_profile(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine import profile as P
        from junction.apps.builtins.auto_improvement.spine import stub_profile as S
