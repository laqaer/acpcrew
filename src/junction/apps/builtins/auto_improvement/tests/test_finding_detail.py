...
class TestCommitButton:
    ...
    async def test_a_draft_while_a_run_is_live_is_refused_with_409(
        ...
        """
        from junction.apps.builtins.auto_improvement.backend import commit as commit_mod
        from junction.apps.builtins.auto_improvement.backend import runner
    ...
    async def test_retargeting_during_a_run_is_refused_with_409(
        ...
        """
        from junction.apps.builtins.auto_improvement.backend import runner, store
    ...
    async def test_a_successful_setup_persists_the_config(
        ...
        """
        from junction.apps.builtins.auto_improvement.backend import clone_setup, store
...
class TestServedEvidenceIsRedacted:
    ...
    def test_a_credential_in_a_diff_does_not_reach_the_browser(self) -> None:
        from junction.apps.builtins.auto_improvement.backend.routes import (
            _redact_for_display,
        )
    ...
    def test_redactor_failure_withholds_rather_than_leaks(self, monkeypatch) -> None:
        ...
        # Patch the name ROUTES holds, not `junction.security.redact`: the import is at
...
class TestAllAgentAuthoredFieldsAreRedacted:
    ...
    def test_the_gate_tree_is_redacted_recursively(self) -> None:
        from junction.apps.builtins.auto_improvement.backend.routes import _redact_tree
