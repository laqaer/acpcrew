...
from junction.apps.builtins.auto_improvement.spine.agent_runner import _adopt_authored_test
...
class TestTheInventedSlugCollides:
    ...
    def test_two_distinct_loci_produce_the_same_invented_path(self) -> None:
        a = "src/junction/apps/builtins/auto_improvement/spine/archive.py::Archive.top_k"
        b = "src/junction/apps/builtins/auto_improvement/spine/keeper.py::fingerprint"
...
class TestArchiveTsvSurvivesAgentText:
    ...
    def test_a_tab_or_newline_in_a_cell_does_not_break_the_row(self, tmp_path: Path) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.archive import (
            CONTROL_COLUMNS,
            Archive,
        )
