...
from junction.apps.builtins.auto_improvement.spine.driver import BudgetCaps
...
class TestMetricDirectionIsPlumbed:
    ...
    def test_the_driver_passes_a_direction_to_the_keeper(self) -> None:
        from junction.apps.builtins.auto_improvement.spine import driver as D
    ...
    def test_direction_is_read_off_the_ruler_and_normalized(self, raw, expected) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.driver import Driver
...
class TestFanOutIsDisjoint:
    ...
    def test_deep_does_not_overlap_wide(self) -> None:
        from junction.apps.builtins.auto_improvement.spine import proposer as P
...
class TestBudgetDefaultsDoNotStarveCoverage:
    ...
    def test_quiesce_after_is_configurable(self) -> None:
        from junction.apps.builtins.auto_improvement.backend import routes
...
class TestNestedTargetJoinsItsEvidence:
    ...
    (``junction_apps_builtins_auto_improvement_spine_contracts_py_proposal``) and
    ...
    def test_a_nested_target_slugs_to_its_basename(self) -> None:
        from junction.apps.builtins.auto_improvement.backend.progress import _target_slug

        slug = _target_slug(
            "src/junction/apps/builtins/auto_improvement/spine/contracts.py::Proposal"
        )
    ...
    def test_the_slug_matches_the_proposers_own_token(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend.progress import _target_slug
        from junction.apps.builtins.auto_improvement.spine.proposer import _short
...
class TestRetargetClearsRepoScopedConfig:
    ...
    def test_retarget_drops_the_previous_repos_branch(self, tmp_path, monkeypatch) -> None:
        from junction.apps.builtins.auto_improvement.backend import routes, store
...
class TestReproTestDirIsRepoAware:
    ...
    def _profile(self, clone: Path):
        from junction.apps.builtins.auto_improvement.profiles.github_repo.profile import (
            build_profile,
        )
    ...
    def test_the_runner_helper_agrees_with_the_profile(self, tmp_path: Path) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.agent_runner import (
            _repro_test_dir,
        )
...
class TestCheckoutPrecedesProfileBuild:
    ...
    def test_checkout_happens_before_build_profile(self, monkeypatch, tmp_path) -> None:
        import junction.apps.builtins.auto_improvement.profiles as profiles_mod
        from junction.apps.builtins.auto_improvement.backend import clone_setup
        from junction.apps.builtins.auto_improvement.backend.runner import RunSupervisor
...
class TestSubprocessFallbackIsAudited:
    ...
    def test_launch_is_logged_before_the_spawn(self, monkeypatch) -> None:
        import junction.sel as sel_mod
        from junction.apps.builtins.auto_improvement.spine import agent_runner as ar
...
class TestActivityFeedIsRedacted:
    ...
    def test_a_credential_in_agent_text_is_redacted(self) -> None:
        from junction.apps.builtins.auto_improvement.backend.runner import _redact_activity
...
class TestFallbackAuditsEveryToolItUses:
    ...
    def test_the_target_hint_is_redacted(self, monkeypatch) -> None:
        ...
        Uses an AWS access-key id, which `junction.security.redact` matches by SHAPE.
    ...
    def test_a_broken_redactor_never_emits_raw_agent_text(self, monkeypatch) -> None:
        ...
        import junction.security as security_mod
        import junction.sel as sel_mod
    ...
    def test_the_stream_loop_audits_tool_events(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.agent_runner import AgentRunner
...
class TestProvisionalCommitMessageCarriesNoModelText:
    ...
    def test_a_credential_shaped_symbol_survives_into_cand_id(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.proposer import _disambig, _short
...
class TestCalibrationRefusesABadCanary:
    ...
    def _canary(*, ok: bool, delta: float | None):
        from junction.apps.builtins.auto_improvement.spine.contracts import Measurement

        return Measurement(ok=ok, primary_delta=delta)

    def test_a_regression_is_not_a_cleared_canary(self) -> None:
        from junction.apps.builtins.auto_improvement.spine.preflight import (
            _canary_clears_band,
        )
...
class TestTheCredentialScanCannotSelfDiff:
    ...
    def _recipe(self, tmp_path: Path, base_ref: str):
        from junction.apps.builtins.auto_improvement.profiles.github_repo.pr_recipe import (
            GitHubPRRecipe,
        )
...
class TestBrowserServedFeedsFailClosed:
    ...
    def test_the_watcher_log_withholds_unscannable_text(self, monkeypatch) -> None:
        import junction.security as security_mod
        from junction.apps.builtins.auto_improvement.backend import pr_watchers
...
class TestAQueuedChangeIsNotRecordedAsFiled:
    ...
    def test_the_pipeline_branches_on_the_queued_prefix(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.pr_pipeline import CrPipeline
...
class TestAgentTestsCannotWriteJunctionConfig:
    ...
    `open('~/.junction/config.json','a')` and exited 0 — it MODIFIED Junction's own
    ...
    def test_the_masked_targets_are_directories_that_exist(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.profiles.github_repo import profile as P
    ...
    def test_it_covers_every_write_protected_path(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.profiles.github_repo import profile as P
        from junction.security import write_protected_home_paths
...
class TestFallbackAgentCannotSeeCredentials:
    ...
    def test_the_spawn_requests_strict_mode(self, monkeypatch, tmp_path) -> None:
        ...
        # `junction.sandbox` would not affect the already-bound reference.
...
class TestTheWatcherRefusesToRunWithoutEgressAcknowledgement:
    ...
    def test_the_config_key_is_writable(self) -> None:
        from junction.apps.builtins.auto_improvement.backend.routes import _CONFIG_WRITABLE
...
class TestTheLoopRunnerRefusesWithoutCredentialConfinement:
    ...
    def test_an_unreadable_config_fails_closed(self, monkeypatch) -> None:
        ...
        import junction.config as cfgmod

        monkeypatch.setattr(cfgmod, "JunctionConfig", _Boom)
...
class TestAgentRegistrationFailsClosed:
    ...
    agent, which carries the full junction-core toolset including ``spawn_sub_agents``.
...
class TestProvisionalCommitFailsClosed:
    ...
    def test_a_failing_commit_returns_false_not_true(self, tmp_path, monkeypatch) -> None:
        from junction.apps.builtins.auto_improvement.spine import driver as drv_mod
        from junction.apps.builtins.auto_improvement.spine.contracts import (
            TRACK_PERF,
            Candidate,
            Proposal,
...
class TestFallbackAgentInheritsNoCredentials:
    ...
    was TRUE even after the spawn was sandboxed: `junction.sandbox.scrub_env` covers
...
class TestApprovalAuditReallyLandsOnDisk:
    ...
    def test_a_real_sel_write_produces_a_readable_event(self, tmp_path, monkeypatch) -> None:
        ...
        # constructs it, its `_dir` is fixed and a later `JUNCTION_HOME` env change is inert
...
class TestToolRequestsAreGated:
    ...
    def test_a_broken_governance_hook_denies_rather_than_authorizes(self, monkeypatch) -> None:
        ...
        import junction.config as cfg_mod
        from junction.apps.builtins.auto_improvement.spine.agent_runner import (
            _governance_denial,
        )
        ...
        monkeypatch.setattr(cfg_mod.JunctionConfig, "load", staticmethod(_boom))
    ...
    def test_allowlist_is_enforced_deny_by_default_when_supplied(self) -> None:
        from junction.apps.builtins.auto_improvement.spine.agent_runner import _tool_permitted
...
class TestSecurityDecisionsAreNotDuplicated:
    ...
    def test_both_untrusted_execution_paths_use_the_same_object(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.push_policy import (
...
class TestALandedCommitSupersedesItsFiledRow:
    ...
    def test_the_recorded_status_supersedes_filed(self, tmp_path, monkeypatch) -> None:
        from junction.apps.builtins.auto_improvement.backend import ledger_admin as LA
    ...
    def test_the_status_constant_matches_the_spine(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend import ledger_admin as LA
        from junction.apps.builtins.auto_improvement.spine import ledger as real
...
class TestCommitMessageRedactionFailsClosed:
    ...
    def test_one_click_commit_message_falls_back_on_a_broken_redactor(
        ...
        # there, so it is bound at import time and patching `junction.security` would
...
class TestAnUnprovenRulerHaltsThePerfTrack:
    ...
    def test_the_backend_default_is_strict(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend import runner as runner_mod
    ...
    def test_an_operator_can_still_opt_out(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend.runner import _as_bool
...
class TestRunStartupSharesTheCloneLock:
    ...
    def test_startup_holds_the_lock_while_it_touches_the_clone(self, monkeypatch) -> None:
        ...
        from junction.apps.builtins.auto_improvement import profiles as profiles_pkg
...
class TestTheProfileImportStaysLazy:
    ...
    def test_importing_the_backend_does_not_pull_the_profile_tree(self) -> None:
        ...
        code = (
            "import sys\n"
            "import junction.apps.builtins.auto_improvement.backend.runner\n"
            "heavy = 'junction.apps.builtins.auto_improvement.profiles.github_repo.profile'\n"
            "print(1 if heavy in sys.modules else 0)\n"
        )
        # A CLEAN interpreter, so this measures a real boot rather than whatever the test
        # session has already imported. `junction` may be on the path via the source tree
        # rather than installed, so its parent is passed through explicitly.
        env = dict(os.environ)
        src_root = str(Path(junction.__file__).resolve().parent.parent)
...
class TestRetargetIsAtomicWithRunStartup:
    ...
    def test_setup_holds_the_clone_lock_across_clone_and_persist(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend import routes as routes_mod
...
class TestAFailedExportDoesNotDeleteTheWork:
    ...
    def test_an_export_failure_retains_the_clone(self, tmp_path, monkeypatch) -> None:
        from junction.apps.builtins.auto_improvement.backend import pr_watchers as pw
...
class TestRepoControlledGitHooksDoNotExecuteHostSide:
    ...
    def test_the_pin_refuses_a_symlink_and_fails_closed(self, tmp_path) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine import git_safety as gs
    ...
    def test_every_host_side_git_helper_injects_the_safe_config(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend import clone_setup as clone_mod
        from junction.apps.builtins.auto_improvement.backend import commit as commit_mod
        from junction.apps.builtins.auto_improvement.backend import pr_watchers as pw_mod
        from junction.apps.builtins.auto_improvement.profiles.github_repo import (
            pr_recipe as recipe_mod,
        )
        from junction.apps.builtins.auto_improvement.spine import agent_discovery as disc_mod
        from junction.apps.builtins.auto_improvement.spine import driver as drv
        from junction.apps.builtins.auto_improvement.spine import gate as gate_mod
        from junction.apps.builtins.auto_improvement.spine import proposer as prop_mod
        ...
        from junction.apps.builtins.auto_improvement.spine import git_safety
    ...
    def test_red_base_staging_does_not_dereference_a_credential_symlink(self, tmp_path) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.gate import Gate
...
class TestANestedProcessCannotAuthenticateToGitHub:
    ...
    def test_the_stored_credential_route_is_closed(self) -> None:
        ...
        from junction.sandbox import _STRICT_DIRS
...
class TestAFailedHeadCheckoutRefusesTheClone:
    ...
    def test_a_missing_head_branch_is_an_error_not_a_silent_base_checkout(self, tmp_path) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend.pr_watchers import (
...
class TestAConfiguredScopeNeverFailsOpen:
    ...
    def test_a_resolvable_base_with_no_merge_base_is_refused(self, tmp_path) -> None:
        ...
        from junction.apps.builtins.auto_improvement.profiles import build_profile
...
class TestMcpErrorsAreRedacted:
    ...
    def _call(self, tmp_path, monkeypatch, fp: str):
        ...
        from junction.apps.builtins.auto_improvement.backend import mcp_server as m
...
class TestDiscoveryHasNoShell:
    ...
    def test_discovery_is_not_granted_a_shell(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine import agent_discovery as ad
...
class TestTheMcpServerLaunchesOnEveryPlatform:
    ...
    already written down twice:
      * `mcp_gateway/rewriter.py` bakes `sys.executable` into its stub entry precisely because
        "a `python3` on PATH that can import `junction` is [not] guaranteed" — kiro-cli strips
    ...
    interpreter, which is the only value guaranteed to import `junction`. Raised by the GPT
...
class TestPublicationSurvivesALedgerFailure:
    ...
    def test_the_pipeline_keeps_the_filed_outcome_when_the_ledger_raises(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine import ledger as L
        from junction.apps.builtins.auto_improvement.spine import pr_pipeline as pp
...
class TestTheGovernanceGateGetsBothDenyInputs:
    ...
    def test_the_two_config_builders_really_differ(self, tmp_path, monkeypatch) -> None:
        ...
        monkeypatch.setenv("JUNCTION_HOME", str(tmp_path))
        from junction.config.loader import denied_commands_path
        from junction.hooks import HooksConfig, hooks_config_from_config_dict
...
class TestOnlyTheBugTrackMayAddTests:
    ...
    def test_the_perf_track_cannot_add_a_test(self) -> None:
        from junction.apps.builtins.auto_improvement.spine.contracts import TRACK_PERF
    ...
    def test_the_bug_track_can_still_add_a_test(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.spine.contracts import TRACK_BUG
    ...
    def test_the_profile_passes_its_track_to_the_fence(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.profiles.github_repo import profile as gp
...
class TestUnresolvedThreadsActuallyBlockPublish:
    ...
    def test_unresolved_counting_matches_the_provider_shape(self) -> None:
        ...
        from junction.apps.builtins.auto_improvement.backend.pr_checks import _count_unresolved
    ...
    def test_the_verdict_reports_progress_for_an_open_thread(self) -> None:
        ...
        """
        from junction.apps.builtins.auto_improvement.backend.pr_checks import (
            _count_unresolved,
            derive_verdict,
        )
