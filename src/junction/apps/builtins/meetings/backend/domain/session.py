...
the shared :class:`~junction.session.SessionManager` via
:func:`~junction.llm_helpers.stream_and_collect` — no socket, no secret, no
second copy of the auth path. Approval runs under
:data:`~junction.llm_helpers.ToolApprovalPolicy.HOOK_BASED` so the agents'
