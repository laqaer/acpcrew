...
Two extension points, both shaped like ``junction.embeddings``'s
...
from junction.apps.builtins.meetings.backend.providers.calendar import (  # noqa: F401
    CalendarEvent,
    CalendarProvider,
...
from junction.apps.builtins.meetings.backend.providers.tasks import (  # noqa: F401
    TaskDraft,
    TaskProvider,
    TaskRef,
