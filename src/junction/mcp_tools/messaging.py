...
from junction.security import BINARY_MIME_ALLOWLIST, redact_credentials, redact_exfiltration_urls
from junction.validation import _SLACK_TS_RE, CHANNEL_ID_RE
...
def send_message(name: str, args: dict[str, Any]) -> str:
    ...
    # auto-approved junction-core call (default allowedTools) emits no
