...
from junction.validation import LEARN_ADD_SCHEMA, MAX_SHORT_STRING
                ...
                "properties": {
                    ...
                    "repo_scope": {
                        ...
                        "description": (
                            ...
                            "(e.g. 'src/junction'). The correction then applies "
    ...
    if err_val:
        ...
        if d.get("code") == "unknown_session":
            return (
                ...
                "thread), or use `junction learn remove` from a shell."
            )
        return f"Error: {err_val}"
