...
from junction import mcp_core, platform_compat, session_directive
...
def wait(name: str, args: dict[str, Any]) -> str:
    ...
    # JUNCTION_SESSION_KEY) a subagent's sleep would publish its deadline onto
    ...
    # caller context, JUNCTION_SESSION_KEY, or a HMAC-verified pid sidecar.
