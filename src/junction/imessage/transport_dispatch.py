...
from junction.imessage.client import redact_handle
from junction.imessage.commands import HELP_TEXT, ConversationState, parse_command
...
from junction.messaging.link import build_dm_session_key, seed_generation
...
if TYPE_CHECKING:
    ...
    from junction.imessage.client import IMessageClient, IMessageInbound
    from junction.session import SessionManager

logger = logging.getLogger(__name__)

# Canonical kiro-cli agent fallback so iMessage sessions load junction-core
...
# channels' _DEFAULT_JUNCTION_AGENT.
    ...
    async def handle_message(self, inbound: "IMessageInbound") -> None:
        ...
        await drive_turn(
            ChannelTurn(
                ...
                # grant the dashboard toggle and Slack's `/junction yolo` drive,
