...
from junction._sqlite_compat import FTS5_UNAVAILABLE_HINT, fts5_available, sqlite3
...
from junction.metrics.db_metrics import timed, timed_query
from junction.platform_compat import file_lock, is_link_or_junction
...
class MemoryStore:
    ...
    def _atomic_write_text(self, path: Path, content: str) -> None:
        ...
        to :func:`junction.atomic_write.atomic_write`, which stages the
    ...
    def append_history(self, entry: str) -> None:
        ...
        :func:`junction.platform_compat.file_lock` (real cross-platform locking
    ...
    def _guarded_entry(self, path: Path) -> dict:
        ...
        through :func:`junction.hooks.safe_read_file_bytes_nolink` confined
