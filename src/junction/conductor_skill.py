...
Loaded into the default junction agent so delegation is transparent. The crew
...
You (junction) are the default crew and handle most tasks directly. Delegate only
