...
:mod:`junction.messaging.status_reactions`, driven through a sink bound to the
...
Length splitting belongs to :func:`junction.messaging.split.split_markdown_safe`,
...
from junction.constants import split_trailing_protocol_suffix
...
from junction.messaging.approval import APPROVAL_TIMEOUT_S
