...
stay in ``junction.messaging.attachments``.
"""
...
# ``from junction.discord.attachments import append_attachment_context``
...
# Kept in this module's public API so existing `from junction.discord.attachments
