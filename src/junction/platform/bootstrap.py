...
from junction.platform.discovery import discover_companion_context, plugin_entry_points
from junction.platform.governance import (
    assert_governance_paths_protected,
    assert_policy_signature_satisfied,
    load_security_policy,
)
from junction.platform.profile import resolve_profile
from junction.platform.security_authority import PolicyAuthority, assert_security_floor
...
def boot_platform(cfg: "JunctionConfig") -> PlatformContext:
...
def build_default_context(
    cfg: "JunctionConfig", *, profile: str = PROFILE_STANDALONE
) -> PlatformContext:
...
def bootstrap_context(cfg: "JunctionConfig") -> PlatformContext:
