"""Junction platform contract — the Composed Platform Providers (CPP) seam.

Public API for booting and reading the platform context.  Core code imports
from ``junction.platform`` only; an enterprise companion imports
...
from junction.platform.bootstrap import boot_platform, bootstrap_context, build_default_context
...
from junction.platform.discovery import PLUGIN_GROUP, PluginAdmissionError
