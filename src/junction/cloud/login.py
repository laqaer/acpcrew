...
+ code, and open that URL in the user's *local* browser. Junction stores **no**
...
_LOGIN_LOG_PATH = "/tmp/junction-kiro-login.log"
_LOGIN_PID_PATH = "/tmp/junction-kiro-login.pid"
_LOGIN_FIFO_PATH = "/tmp/junction-kiro-login.stdin"
...
def _open_browser(url: str) -> bool:
    ...
    try:
        ...
        from junction.cloud.connect import redact_token
