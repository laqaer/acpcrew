...
Thin verb layer over :mod:`junction.pod.runtime` / :mod:`junction.pod.unit`.
Dispatched from :func:`junction.cli_commands._pod`.
"""
...
def _cleanup_internal(cfg: PodConfig, args: argparse.Namespace) -> None:
    ...
    Not wired to a service-manager hook (see :mod:`junction.pod.unit` for why
