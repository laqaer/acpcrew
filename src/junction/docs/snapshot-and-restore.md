...
junction restore snapshot.tar.gz --components memory,crons
junction restore snapshot.tar.gz --dry-run            # preview, write nothing
junction restore --list-components                    # show component names
```
