#!/usr/bin/env python3
"""Detach a per-app backend from the shared Junction CloudFront distribution.
...
def aws(profile, region, *args):
    ...
    # junction wasn't importable is exactly the environment an attacker would
    ...
    # bare python3 without junction on sys.path.
    try:
