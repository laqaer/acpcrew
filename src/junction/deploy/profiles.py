...
Security boundary (mirrors ``junction.metrics.profile_install``, the
...
from junction.constants import AWS_PROFILE_NAME_RE
...
# pods/tests with JUNCTION_HOME override isolate correctly.
...
def create_aws_profile(name: str, region: str, *, account: str = "",
    ...
    if account and role:
        ...
        script = (
            ...
            '"--role-session-name","junction-deploy",'
