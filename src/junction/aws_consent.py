...
and Amazon Transcribe (speech-to-text, :mod:`junction.transcribe` and
:mod:`junction.dashboard.stt_stream`). Both omit ``--profile`` / pass no
...
from junction.constants import AWS_PROFILE_FIRST_CHARS
...
async def probe_identity(profile: str, region: str, *, use_cache: bool = True) -> Identity:
    ...
    Delegated to :func:`junction.cloud.aws.run_aws` rather than spawning the CLI
