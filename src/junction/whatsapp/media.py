...
an :class:`junction.messaging.attachments.Attachment`: fetching needs the live
...
#: :func:`junction.messaging.attachments.ingest_attachments` can turn them into
...
def unsupported_note(desc: MediaDescription) -> str:
    ...
    :func:`junction.messaging.attachments.append_attachment_context` appends a
