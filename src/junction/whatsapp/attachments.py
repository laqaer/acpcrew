...
:mod:`junction.whatsapp.media` decides WHAT arrived from the protobuf alone.
...
from junction.platform_compat import host_available_mib
from junction.whatsapp.media import KIND_VOICE, MediaDescription
