...
from junction.whatsapp.group_gate import build_silence_contract
from junction.whatsapp.jids import is_group_jid, wa_id_to_user_jid
from junction.whatsapp.transport import WHATSAPP_CAPABILITIES, WhatsAppTransport
...
class WhatsAppDispatcher:
    ...
    def _seed_gen(self, scope: str) -> int:
        ...
        exists to prevent.
        """
        from junction.messaging.link import CHAT_TYPE_DIRECT, CHAT_TYPE_FORUM
