...
from junction.whatsapp.jids import normalize_jid
from junction.whatsapp.transport import WhatsAppTransport
from junction.whatsapp.transport_dispatch import WhatsAppDispatcher
...
async def maybe_start_whatsapp(orch: "GatewayOrchestrator") -> "WhatsAppClient | None":
    ...
    if not neonize_available():
        from junction.whatsapp.client import MISSING_EXTRA_HINT
