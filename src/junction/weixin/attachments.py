...
:mod:`junction.messaging.attachments`.

Mirrors :mod:`junction.telegram.attachments` and
:mod:`junction.discord.attachments` -- same shared pipeline, only the envelope
...
from junction.weixin.client import ITEM_FILE, ITEM_IMAGE, ITEM_VIDEO, ITEM_VOICE
from junction.weixin.media import CDN_BASE_URL, download_media, media_ref
