...
split into chunks by :mod:`junction.weixin.renderer_chunks`. While the turn
...
from junction.messaging.renderer import Renderer, render_options_as_text
from junction.messaging.transport import TransportCapabilities
from junction.weixin.client import TYPING_START, TYPING_STOP
from junction.weixin.renderer import render_chunks
