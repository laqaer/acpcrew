...
def _default_dir() -> Path:
    ...
    :mod:`junction.sel` never triggers the one-time data-home migration as an
...
def _redact_text(text: str) -> str:
    ...
    """
    # circular import: junction.security imports SecurityEvent/SecurityEventLog
...
class SecurityEvent:
    ...
    agent: str  # agent name (junction, custom, etc.)
...
class SecurityEventLog:
    ...
    def _forward_event(self, callback: Callable[[dict], None], event: SecurityEvent) -> None:
        ...
        try:
            # circular import: junction.security imports SecurityEvent/
...
def sel_hmac_key_path() -> Path:
    ...
    (e.g. via ``config_dir()``; ``_default_dir()`` honors ``JUNCTION_HOME`` the
