...
:mod:`junction.messaging.session_resume`, shared with Discord. This module is only what
is Teams-shaped:
...
from junction.messaging.driver import sanitize_channel_replay_text
from junction.messaging.link import ChannelLink
from junction.messaging.session_resume import ResumeReleaseError  # noqa: F401  (re-export)
from junction.messaging.session_resume import (
    PICKER_LIMIT,
    InboundResolution,
    PickerRegistry,
    ResumeCopy,
...
from junction.teams.cards import session_picker_card
from junction.teams.client import TEAMS_MAX_TEXT, TeamsSendError
from junction.teams.renderer import _display_safe
...
class TeamsSessionResume:
    ...
    async def choose(
        ...
        async def _settle(text: str) -> bool:
            ...
            try:
                from junction.teams.cards import resolved_card
