...
inbound token verification (an optional ``junction[teams]`` extra). This keeps
...
from junction.teams.attachments import quoted_reply_text
from junction.teams.commands import STOP_ALIASES

logger = logging.getLogger(__name__)

# PyJWT is an optional dependency (junction[teams]); the channel refuses to
...
class TeamsInbound:
    ...
    :mod:`junction.teams.attachments`, downstream of the transport's
...
class TeamsClient:
    ...
    async def send_inline_image(
        ...
        :func:`junction.teams.attachments.inline_image_attachment`.
