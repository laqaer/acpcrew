...
via JUNCTION_KNOWLEDGE_FETCH_TOOLS). If the backend has no fetch tool available,
...
async def fetch_url_content(url: str, pool: "LLMPool") -> str:
    ...
    backend exposes (configurable via JUNCTION_KNOWLEDGE_FETCH_TOOLS); if none is
