...
Wraps the shared ``LlamaCppEmbedder`` from ``junction.embeddings``. Returns
...
class InProcessEmbedder:
    ...
    def _get_embedder(self) -> "EmbeddingBackend":
        ...
        # patches of junction.embeddings.get_shared_embedder stay effective.
