"""Schema registry for Junction configuration.
...
def build_json_schema(root_cls: type) -> dict:
    ...
    # (JunctionConfig itself doesn't have field metadata since it's the root)
    return schema
...
JSON_SCHEMA: dict = build_json_schema(JunctionConfig)
