...
from junction.slack.format import build_options_selected_blocks, replace_options_blocks
from junction.slack.retry import is_retryable_slack_error
...
def encode_options_token(session_key: str, row_ts: str) -> str | None:
    ...
    :func:`junction.history.monotonic_transcript_ts`), so it stays comparable
    across a restart.
