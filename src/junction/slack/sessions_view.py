...
:mod:`junction.messaging.sessions_view`, shared with the chat channels'
...
Beyond ``junction.slack.blocks.session_task_card`` this module has no
...
from junction.messaging.sessions_view import (  # noqa: F401 — re-exported surface
...
from junction.messaging.sessions_view import _collect_recent_sessions as _collect_neutral
from junction.messaging.sessions_view import (  # noqa: F401 — re-exported surface
    _default_session_title,
)
from junction.security import redact_credentials, redact_exfiltration_urls
from junction.slack.blocks import session_task_card
...
def _build_sessions_blocks(
    ...
    shared :func:`junction.slack.blocks.session_task_card` builder so the
