...
from junction.constants import OPTIONS_RE_LINE
from junction.messaging.display_safety import redact_for_display, strip_ansi
from junction.messaging.renderer import cap_choices, format_overflow
...
def build_options_blocks(
    ...
    *staleness_token* rides on the actions block's ``block_id``, which Slack
    ...
    :func:`junction.slack.outbound.encode_options_token`. Omitting it posts a
...
def build_options_selected_blocks(
    ...
    *,
    ...
    """
    from junction.slack.transport import SLACK_CAPABILITIES  # circular (see above)
    ...
    *,
    ...
    Args:
        ...
        redactor: Text-to-text redactor. Defaults to the platform-context shim
            :func:`junction.platform.context.redact_via_context`, which is
