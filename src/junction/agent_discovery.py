...
agents, including Junction's own agent and any agents shipped by
...
from junction.agent_files import AGENT_FILENAME, LITE_AGENT_FILENAME
from junction.config.paths import kiro_agents_dir, project_agents_dir, project_kiro_dir
...
class AgentInfo:
    ...
    source: str = "builtin"  # "junction" | "package" | "builtin"
...
def _read_agent_spec(path: Path) -> dict[str, Any] | None:
    ...
    :func:`junction.hooks.safe_read_file_bytes` — the hardened gate every other
