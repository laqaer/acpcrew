...
def register(app: web.Application) -> None:
    ...
    app.router.add_post("/api/agents/sync", handlers.api_junction_agents_sync)
    app.router.add_put("/api/agents/{name}", handlers.api_junction_agent_update)
    app.router.add_delete("/api/agents/{name}", handlers.api_junction_agent_delete)
