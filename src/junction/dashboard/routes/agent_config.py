...
from junction.dashboard.handlers.mcp_custom import (
    api_mcp_custom_add,
    api_mcp_custom_get,
    api_mcp_custom_update,
)
from junction.dashboard.handlers.mcp_discover import (
    api_mcp_discover,
...
def register(app: web.Application) -> None:
    ...
    app.router.add_patch("/api/config/junction", handlers.api_junction_config_patch)
