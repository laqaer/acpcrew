...
:mod:`junction.session_summary` before the model sees them; the rest are
...
from junction.llm_helpers import _extract_json_of_type, run_bg_oneliner
...
async def generate_session_summary(
    ...
    *,
    ...
    if log is None:
        return False
    # Off-loop: JunctionConfig.load() stats and reads config files, and this
