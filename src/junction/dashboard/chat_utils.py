...
from junction.history import transcript_sort_key
from junction.hooks import safe_read_file
from junction.messaging.link import canonical_key, is_channel_session_key
...
async def run_config_write(fn, /, *args, **kwargs):
    ...
    """
    from junction.dashboard.handlers.agents import _get_config_lock  # lazy: import cycle
...
def _sync_dashboard_slots(state: "DashboardState") -> None:
    ...
    (see :mod:`junction.session_surface`). A channel-born slot contributes its
