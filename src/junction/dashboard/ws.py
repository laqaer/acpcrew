...
from junction.dashboard.chat_utils import effective_session_key, subagent_event_slot
from junction.dashboard.handlers.updates import status_update_fields
from junction.dashboard.origin import check_origin
from junction.dashboard.state import DashboardState, _safe_folder_tree
...
def broadcast_side_result(
    ...
    *,
    ...
    translated from upstream ``"btw"`` to Junction's ``"side"``.
...
def _handle_slot_focused(
    ...
    *,
    ...
    from junction.dashboard.chat_runner import schedule_eager_spawn
...
async def api_ws(request: web.Request) -> web.WebSocketResponse:
    ...
    from junction.dashboard.handlers import _log_ring
