...
# first attribute access; ``from junction.dashboard import <submodule>``
...
if TYPE_CHECKING:  # names for static type checkers only
    from junction.dashboard.server import start_api_server, start_dashboard
    from junction.dashboard.state import DashboardState, _ChatSlot, _fmt_duration
