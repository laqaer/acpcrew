...
``junction.dashboard.handlers.themes`` and import from here; this module must
...
# declaring a higher major is rejected with an honest "needs a newer Junction"
...
def _validate_theme_dir(
    ...
    # for a newer Junction gets the honest version message, not an opaque
