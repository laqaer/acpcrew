...
from junction.acp.runtime import _get_rss_tree_mb, _iter_descendant_pids
from junction.dashboard.handlers_system import _get_static_system_info
...
from junction.subagent import _CLK_TCK, _subtree_cpu_jiffies
...
class SessionMemorySampler:
    ...
    def _blocking_sample(self, rows: list[dict[str, object]]) -> dict[str, object]:
        ...
        from junction.dashboard.handlers.usage import slot_spend
