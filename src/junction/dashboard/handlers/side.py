...
from junction.dashboard.side_context import build_side_message
...
from junction.security import StreamRedactor, redact
...
async def _run_side_turn(
    ...
    *,
    ...
    auth_required = False
    try:
        # Resolve the Junction slot agent name (e.g. "default") to the real
        # kiro-cli agent (e.g. "junction") before creating the session. Passing
