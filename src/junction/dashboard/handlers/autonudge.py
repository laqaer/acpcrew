...
from junction.autonudge_authz import (  # noqa: F401 - re-exported
...
from junction.session_ledger import ledger_key, render_snapshot
...
async def api_autonudge_start(request: web.Request) -> web.Response:
    ...
    if svc is None:
        return web.json_response(
            {
                "error": "auto-nudge disabled (JUNCTION_AUTONUDGE not set)",
