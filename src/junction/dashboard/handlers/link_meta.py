...
:mod:`junction.link_unfurl`. This module owns the parts that need a loop: the
...
from junction.link_unfurl import (
...
_USER_AGENT = "Junction-LinkPreview/1"
...
async def link_meta_get(request: web.Request) -> web.Response:
    ...
    """
    # Offloaded: JunctionConfig.load() stats, reads and validates config files,
