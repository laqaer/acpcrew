...
runtime service (RTS). This module calls that same API so Junction surfaces the
...
_USER_AGENT = "AmazonQ-For-CLI/1.24.0 ua/2.0 os/linux lang/rust Junction"
_TIMEOUT_SECS = 15
...
def _map_response(data: dict) -> dict | None:
    """Translate a GetUsageLimits response into Junction's canonical usage dict.
