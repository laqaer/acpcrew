...
stores underneath (see :mod:`junction.session_storage`), but that is an
...
from junction.history import transcript_stems
from junction.security import redact_credentials, redact_exfiltration_urls
from junction.session_digest import digest
from junction.session_map import SessionMap
from junction.session_storage import (
    BUCKET_DAYS,
...
def _build_index(state: DashboardState | None = None) -> SessionIndex:
    ...
    Stems come from :func:`junction.history.transcript_stems`, which returns both
