...
from junction.artifacts import get_default_store
...
from junction.knowledge.agent_fetch import fetch_url_content
from junction.knowledge.agent_source import add_agent_document
from junction.knowledge.artifact_ingest import ArtifactKnowledgeSync
from junction.knowledge.autosource import AUTO_ADDED_PROP
from junction.knowledge.chunker import HeadingAwareChunker
from junction.knowledge.connectors.base import BaseConnector
...
from junction.knowledge.ingestion import (
    IngestionPipeline,
    _redact,
    rebuild_embeddings,
    start_rebuild_job,
)
from junction.knowledge.llm_pool import DEFAULT_EXTRACTION_EFFORT, LLMPool
...
from junction.knowledge.store import KnowledgeBundleError
...
def _create_embedder(app):
    """Create embedder from Junction config. Returns None if disabled/unavailable."""
...
async def _start_artifact_ingest_async(app: web.Application) -> None:
    ...
    ``junction.knowledge.artifact_ingest`` for the full design.
    """
