...
from junction.config.loader import JunctionConfig, config_dir, config_path  # noqa: F401
from junction.dashboard.handlers_system import (  # noqa: F401
...
from junction.dashboard.origin import is_loopback  # noqa: F401
from junction.security import (  # noqa: F401
    is_sensitive_path,
    redact_credentials,
    redact_exfiltration_urls,
)
from junction.session import _sync_kill_provider  # noqa: F401


def sel():
    """Dynamic sel() that always resolves from junction.sel for test patching."""
    from junction.sel import sel as _s
...
from junction.dashboard.cron_inject import inject_cron_result_to_dashboard  # noqa: E402, F401

# ── Memory (extracted to handlers/memory.py) ──
from junction.dashboard.handlers._shared import (  # noqa: E402, F401
...
from junction.dashboard.handlers.agents import (  # noqa: E402, F401
    _auto_install_agent,
    _find_agent_config,
    _get_config_lock,
    ...
    api_junction_agent_resolved_model,
    api_junction_agent_update,
    api_junction_agents,
    api_junction_agents_create,
    api_junction_agents_sync,
    api_models,
    api_slash_commands,
)

# ── Connections OAuth relay (handlers/connections.py) ──
from junction.dashboard.handlers.connections import (  # noqa: E402, F401
...
from junction.dashboard.handlers.cron import (  # noqa: E402, F401
    api_cron_ack,
...
from junction.dashboard.handlers.diagnostics import (  # noqa: E402, F401
    api_diagnostics_collect,
    api_diagnostics_download,
)

# ── Files & Workspaces (extracted to handlers/files.py) ──
from junction.dashboard.handlers.files import (  # noqa: E402, F401
...
from junction.dashboard.handlers.hooks import (  # noqa: E402, F401
    _get_hook_store,
    _load_hook_context,
    _run_hook_agent,
    _run_hook_inner,
...
from junction.dashboard.handlers.mcp_apps import (  # noqa: E402, F401
    api_mcp_apps_call,
)
from junction.dashboard.handlers.memory import (  # noqa: E402, F401
    _get_vector_store,
...
from junction.dashboard.handlers.messaging import (  # noqa: E402, F401
    _redact,
...
from junction.dashboard.handlers.prompts import (  # noqa: E402, F401
    MAX_PROMPT_BYTES,
...
from junction.dashboard.handlers.session_ledger import (  # noqa: E402, F401
    api_session_ledger_get,
    api_session_ledger_record,
)

# ── Sessions (extracted to handlers/sessions.py) ──
from junction.dashboard.handlers.session_storage import (  # noqa: E402, F401
...
from junction.dashboard.handlers.sessions import (  # noqa: E402, F401
...
from junction.dashboard.handlers.side import (  # noqa: E402, F401
    api_side_close,
    api_side_open,
...
from junction.dashboard.handlers.skill_budget import (  # noqa: E402, F401
    api_skills_budget,
)
from junction.dashboard.handlers.sso_login import (  # noqa: E402, F401
    api_sso_login_ws,
)
from junction.dashboard.handlers.steering import (  # noqa: E402, F401
...
from junction.dashboard.handlers.tailnet import (  # noqa: E402, F401
    api_tailnet_status,
)
from junction.dashboard.handlers.tailnet_mobile import (  # noqa: E402, F401
...
from junction.dashboard.handlers.taskrunner import (  # noqa: E402, F401
    _run_refine,
...
from junction.dashboard.handlers.telemetry import (  # noqa: E402, F401
    api_beacon_status,
...
from junction.dashboard.handlers.terminal import (  # noqa: E402, F401
...
from junction.dashboard.handlers.themes import (  # noqa: E402, F401
    api_theme_asset,
    api_theme_detail,
    api_theme_overlay,
    api_theme_topbar,
...
from junction.dashboard.handlers.updates import (  # noqa: E402, F401
...
from junction.dashboard.theme_validate import (  # noqa: E402, F401
...
def _list_aim_prompts() -> list[dict[str, Any]]:
    ...
    from junction.agent import _project_dir
...
# alongside the ``junction aws-consent`` CLI.
from junction.dashboard.handlers.aws_consent import (  # noqa: E402, F401
...
# loopback legs: ``invoke`` (the ``junction-computer`` MCP shim's forward) and
# ``frame`` (the live-view PiP mirror of an already-captured screenshot).
from junction.dashboard.handlers.computer_use import (  # noqa: E402, F401
...
from junction.dashboard.handlers.core import (  # noqa: E402, F401
    _DIST_DIR,
    _STATIC_DIR,
...
from junction.dashboard.handlers.notifications_push import (  # noqa: E402, F401
    api_push_notification,
)
from junction.dashboard.handlers.onboarding_import import (  # noqa: E402, F401
    api_onboarding_import_apply,
    api_onboarding_import_scan,
    api_onboarding_import_state,
)
from junction.dashboard.handlers.optimizer import (  # noqa: E402, F401
    handle_optimize,
)

# ── Portability (export/import as zip) ──
from junction.dashboard.handlers.portability import (  # noqa: E402, F401
    api_portability_export,
    api_portability_import,
    api_portability_preview,
)
from junction.dashboard.handlers.security import (  # noqa: E402, F401
