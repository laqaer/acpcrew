...
from junction.artifacts import ArtifactNotFoundError, ArtifactValidationError, get_default_store
from junction.dashboard.origin import is_direct_local_request
from junction.deploy.handlers import _allowed_local_roots
                ...
                if "X-Frame-Options" not in resp.headers:
                    ...
                    for directive in csp.split(";"):
                        ...
                        if d.lower().startswith("frame-ancestors"):
                            fa = d.lower()
                            break
                    framable = not fa or "localhost" in fa or "127.0.0.1" in fa or "junction.localhost" in fa
