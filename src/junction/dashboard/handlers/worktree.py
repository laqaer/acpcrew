...
-----------------------
* ``branch`` must satisfy :func:`~junction.validation.is_valid_followup_branch`,
...
from junction.dashboard.chat_handlers import deny_non_dashboard_caller
...
from junction.validation import MAX_FOLLOWUP_BRANCH, is_valid_followup_branch
...
# (`.git/junction-no-hooks`) is resolved relative to the repo, so whoever prepared
