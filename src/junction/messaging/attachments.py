...
IMAGE        a local path the ACP prompt path inlines as an image block
             (see :mod:`junction.acp.prompt_blocks`)
TEXT         redacted, truncated text inlined into the prompt
DOCUMENT     text extracted via :mod:`junction.doc_parser`, then as TEXT
...
from junction.doc_parser import extract_text, is_parseable_document
...
#: Raster types that :func:`junction.acp.prompt_blocks.build_prompt_blocks` can
