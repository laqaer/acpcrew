...
from junction.security import StreamRedactor, redact_credentials, redact_exfiltration_urls
...
# These are Junction-generated status prefixes, not model-authored prose. A
