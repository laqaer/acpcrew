...
subagent manager) can emit ``junction.*`` counters without importing
``metrics.provider`` at module top — that import chain reads JunctionConfig
...
CHILD_PERMISSION_DENIED = "junction.acp.child_permission.denied"
...
DROPPED_FRAMES = "junction.acp.dropped_frames"
...
TURN_TIMEOUT_CAUSE = "junction.turn.timeout.cause"
...
SESSION_IDLE_EXPIRED = "junction.session.idle_expired"
