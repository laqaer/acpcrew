"""Junction computer use — read and drive desktop app windows via accessibility.
...
Architecture in one paragraph: the ``junction-computer`` MCP sidecar dispatches
...
:class:`~junction.computer_use.backend.ComputerUseBackend`. The accessibility
...
from junction.computer_use.index import SnapshotIndex, get_shared_index, reset_shared_index
