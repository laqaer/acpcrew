"""The Cursor Motion overlay RENDERER — a separate process, run as ``python -m``.
    ...
    python -m junction.computer_use.overlay_proc
...
:mod:`junction.computer_use.overlay` before a byte reached this process.
...
if __name__ == "__main__":  # pragma: no cover - process entry point
    logging.basicConfig(level=os.environ.get("JUNCTION_LOG_LEVEL", "WARNING"))
