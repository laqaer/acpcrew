...
from junction.computer_use.types import MAX_SCREENSHOT_MAX_PX, OBS_SCREENSHOT, Snapshot
...
def _ingress_url() -> str:
    ...
    process actually bound over an inherited ``JUNCTION_PORT``, so an auto-port
...
def _headers() -> dict[str, str]:
    ...
    sibling is never reached -- including when an inherited ``JUNCTION_PORT`` names
