...
from junction.computer_use import index
...
def select_default_backend() -> ComputerUseBackend:
    ...
    if platform_compat.IS_MACOS:
        try:
            ...
            from junction.computer_use.macos_driver import MacOSBackend
    ...
    if platform_compat.IS_LINUX:
        ...
        from junction.computer_use.linux_driver import LinuxBackend
