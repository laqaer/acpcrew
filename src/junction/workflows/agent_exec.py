...
from junction.llm_helpers import ToolApprovalPolicy, provider_last_turn_usage, stream_and_collect
    ...
    *,
    ...
    async def agent_fn(prompt: str, opts: dict) -> Any:
        ...
        try:
            ...
            # rows).
            #
            # The import stays function-local on purpose: junction.dashboard.
