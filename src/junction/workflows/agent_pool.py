...
This module reuses the generic, already-tested :class:`junction.acp.worker_pool.WorkerPool`
...
from junction.workflows.agent_exec import _MAX_TURNS_PER_STEP
...
class _WorkflowSessionWorker:
    ...
    Implements the :class:`junction.acp.worker_pool.PoolWorker` protocol. One
