...
try:
    from junction.security import redact_credentials as _redact_credentials
    from junction.security import redact_exfiltration_urls as _redact_exfil
...
# ``junction.sel`` security event log; tests inject a capturing stub. Kept as a
