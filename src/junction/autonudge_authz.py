...
from junction.autonudge import NudgeAdmissionRefused, is_channel_key
from junction.config.loader import workspace_dir_for
...
async def authorize_and_update_nudge(
    *,
    ...
    if svc is None:
        ...
        return None, "auto-nudge disabled (JUNCTION_AUTONUDGE not set)", 503
    if not loop_id:
