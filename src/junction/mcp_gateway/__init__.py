...
This package wires an asyncio local-IPC broker into Junction as a
...
#: ``<python> -m junction.mcp_gateway.stub …``).
#:
...
STUB_MODULE = "junction.mcp_gateway.stub"
...
if TYPE_CHECKING:  # names for static type checkers only
    from junction.mcp_gateway.backend import Backend, send_initialize, spawn_backend
    from junction.mcp_gateway.gatewayd import run_gatewayd
    from junction.mcp_gateway.manager import GatewayManager, GatewaySpec
    ...
    from junction.mcp_gateway.stub import main as stub_main
