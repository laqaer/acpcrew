...
def hash_effective_env(env_pairs: Mapping[str, str], *, identity_keys: Collection[str] = ()) -> str:
    ...
    :class:`junction.mcp_gateway.pool.PoolKey`. Implemented on top of
