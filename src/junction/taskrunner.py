...
from junction.subagent import compute_max_subagents
from junction.task_executor import (
    build_task_prompt,
    execute_single_task,
    run_tests,
)
from junction.task_executor import self_review as self_review_fn

# ── Re-exports (preserve public API) ──
from junction.task_models import (  # noqa: F401
...
from junction.task_planner import (
    auto_name,
    decompose,
    decompose_yaml,
...
from junction.task_planner import plan_to_chat_context as _planner_plan_to_chat_context
from junction.task_planner import (
    update_plan_tasks,
)
from junction.task_reporter import (  # noqa: F401  (NotifyCallback re-exported)
    NotifyCallback,
...
class TaskRunner:
    ...
    def __init__(
        ...
        try:
            auto_cap = compute_max_subagents(JunctionConfig.load())
        except Exception:
