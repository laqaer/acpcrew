...
:mod:`junction.mcp_gateway.socketsec`). Walking that PID's */proc* ancestry
...
from junction.config.loader import config_dir as _default_config_dir
from junction.mcp_caller import _parent_pid as _default_ppid
from junction.session_pid_sig import read_session_pid_txt, verify_session_pid
...
def resolve_peer_identity(
    ...
    * the full HOST ancestor PID chain (peer first). gatewayd indexes stub
    ...
    implementations. Reads go through :func:`~junction.session_pid_sig.
    ...
    verify (:func:`~junction.session_pid_sig.verify_session_pid`, pid bound
