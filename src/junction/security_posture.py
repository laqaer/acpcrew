...
_REDACTION_SINKS: tuple[tuple[str, str, str], ...] = (
    (
        ...
        "(`identityDetail` over `GET /api/aws/consent`) and `junction aws-consent "
...
NON_EGRESS_REDACTION_MODULES: frozenset[str] = frozenset(
    {
        ...
        # The junction-core tool handlers, moved out of mcp_core.py into their
        ...
        # mirrored/presigned JUNCTION_PPTX_ENGINE_URL override cannot leak
        ...
        "builtin_skills/junction-dev/prepare-pr/scripts/pr_findings.py",
...
def _token_auth_items() -> list[PostureItem]:
    # circular import: token_auth lives under junction.dashboard, whose package
...
_CONTROLS: tuple[PostureControl, ...] = (
    ...
    PostureControl(
        ...
        summary=(
            ...
            "are surfaced by the `junction` history scan, NOT blocked at the "
    ...
    PostureControl(
        ...
        source="src/junction/validation.py",
    ...
    PostureControl(
        ...
        source="src/junction/dashboard/token_auth.py",
