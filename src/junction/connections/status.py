...
from junction.connections.registry import Provider, get_visible_providers
...
def _save_connected_since(recorded: dict[str, str]) -> bool:
    ...
    """
    from junction.agent import _atomic_json_write  # circular import at module scope
...
def _reconcile_connected_since_locked(statuses: list[ConnectionStatus], now: str) -> dict[str, str]:
    ...
    if fresh:
        ...
        from junction import hooks as _hooks  # circular import at module scope
...
async def collect_connection_statuses() -> list[ConnectionStatus]:
    ...
    """
    from junction.connections.mint import pending_mint_for
