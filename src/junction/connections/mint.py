...
# ``junction.agent`` is imported as a MODULE, not as symbols: the agents dir and
...
# binding.
from junction import agent as _agent
from junction.acp.client import AcpClient
from junction.agent_files import AGENT_FILENAME, OWNED_KIRO_AGENT_FILES
...
_MINT_AGENT_PREFIX = "junction-mint-"
...
async def start_oauth_mint(
    ...
    try:
        ...
        # Off the loop: resolving the data home creates it when a JUNCTION_HOME
