...
:func:`~junction.mcp_grant.grant_presence` -- paired artifacts stat-ed,
...
from junction.connections.registry import Provider, get_all_registry_providers
from junction.connections.tool_aliases import normalized_endpoint
...
from junction.mcp_grant import grant_presence as grant_present
...
_CLIENT_INFO = {"name": "junction-l1-smoke", "version": "1"}
