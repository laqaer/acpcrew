...
from junction.discord.gateway import maybe_start_discord
from junction.feishu.gateway import maybe_start_feishu
from junction.imessage.gateway import maybe_start_imessage
from junction.messaging.registry import ChannelDescriptor
from junction.teams.gateway import maybe_start_teams
from junction.telegram.gateway import maybe_start_telegram
from junction.webex.gateway import maybe_start_webex
from junction.wecom.gateway import maybe_start_wecom
from junction.weixin.gateway import maybe_start_weixin
from junction.whatsapp.gateway import maybe_start_whatsapp
...
def channel_readiness(cfg: object, creds: Mapping[str, str]) -> tuple[ChannelReadiness, ...]:
    ...
    ``cfg`` is a :class:`~junction.config.loader.JunctionConfig`; each channel's
