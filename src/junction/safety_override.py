...
from junction.sel import sel as _get_sel
...
def sel():  # noqa: ANN201 — thin wrapper kept for test patchability
    ...
    Defined at module level so tests can patch ``junction.safety_override.sel``.
    """
    return _get_sel()
...
def resolve_configured_duration() -> tuple[int, bool]:
    ...
    label = JunctionConfig.load().agent.yolo_duration
