...
KEY_KIND = "junction_kind"
KEY_CHOICE = "junction_choice"
KEY_NONCE = "junction_nonce"
KEY_REQUEST = "junction_request"
...
def options_card(choices: list[str], *, nonce: str) -> dict[str, Any] | None:
    ...
    *choices* must already be capped by
    :func:`junction.messaging.renderer.apply_options_cap`, which is what puts the
